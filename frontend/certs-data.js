...
(function (root, factory) {
    ...
    const CATALOGUE_UPDATED = "2026-06-01"; // Microsoft Certification Poster (June 2026)
    ...
    const CERTS = [
        ...
        { code: "AI-900", title: "Azure AI Fundamentals", cat: "cloud", level: "Fundamentals", provider: "tech", note: "Retires end of June 2026" },
        { code: "AI-901", title: "Azure AI Fundamentals (beta)", cat: "cloud", level: "Fundamentals", provider: "tech", beta: true, isNew: true },
        ...
        { code: "AZ-204", title: "Azure Developer Associate", cat: "cloud", level: "Role-based", provider: "tech" },
        ...
        { code: "AZ-800 / AZ-801", title: "Windows Server Hybrid Administrator Associate", cat: "cloud", level: "Role-based", provider: "tech" },
        { code: "AI-102", title: "Azure AI Engineer Associate", cat: "cloud", level: "Role-based", provider: "tech" },
        { code: "AI-103", title: "Azure AI Apps and Agents Developer Associate", cat: "cloud", level: "Role-based", provider: "tech", beta: true, isNew: true },
        { code: "AI-200", title: "Azure AI Cloud Developer Associate", cat: "cloud", level: "Role-based", provider: "tech", beta: true, isNew: true },
        ...
        { code: "DP-750", title: "Azure Databricks Data Engineer Associate", cat: "cloud", level: "Role-based", provider: "tech", isNew: true },
        ...
        { code: "GH-600", title: "GitHub Agentic AI Developer", cat: "cloud", level: "Specialty", provider: "github", beta: true, isNew: true },
        ...
        { code: "MB-240", title: "Dynamics 365 Field Service Functional Consultant Associate", cat: "aibiz", level: "Role-based", provider: "tech" },
        { code: "MB-280", title: "Dynamics 365 Customer Experience Analyst Associate", cat: "aibiz", level: "Role-based", provider: "tech" },
        ...
        { code: "MB-335", title: "Dynamics 365: Supply Chain Management Functional Consultant Expert", cat: "aibiz", level: "Role-based", provider: "tech", expert: true, prereq: true },
        { code: "MB-500", title: "Dynamics 365: Finance and Operations Apps Developer Associate", cat: "aibiz", level: "Role-based", provider: "tech" },
        { code: "MB-700", title: "Dynamics 365: Finance and Operations Apps Solution Architect Expert", cat: "aibiz", level: "Role-based", provider: "tech", expert: true, prereq: true },
        ...
        { code: "PL-500", title: "Power Automate RPA Developer Associate", cat: "aibiz", level: "Role-based", provider: "tech" },
        { code: "PL-600", title: "Power Platform Solution Architect Expert", cat: "aibiz", level: "Role-based", provider: "tech", expert: true, prereq: true },
        ...
        { code: "AB-620", title: "AI Agent Builder Associate (beta)", cat: "aibiz", level: "Role-based", provider: "business", beta: true, isNew: true },
        { code: "AB-210", title: "Dynamics 365 Sales AI Consultant Associate", cat: "aibiz", level: "Role-based", provider: "business", beta: true, isNew: true },
        { code: "AB-250", title: "Dynamics 365 Contact Center AI Engineer Associate", cat: "aibiz", level: "Role-based", provider: "business", beta: true, isNew: true },
        { code: "AB-410", title: "Intelligent Applications Builder Associate", cat: "aibiz", level: "Role-based", provider: "business", beta: true, isNew: true },
        ...
        { code: "SC-500", title: "Cloud and AI Security Engineer Associate", cat: "security", level: "Role-based", provider: "tech", beta: true, isNew: true },
        { code: "SC-730", title: "Cybersecurity Business Professional", cat: "security", level: "Role-based", provider: "tech", beta: true, isNew: true },
